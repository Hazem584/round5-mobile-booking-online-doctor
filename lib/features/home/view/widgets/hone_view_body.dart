          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  Text('Specialties', style: TextStyles.regular20.copyWith(fontFamily: 'Georgia')),
                  TextButton(
                    onPressed: () {
                    ...
                    child: Text(
                      'View all',
                      style: TextStyles.regular14.copyWith(color: ColorsManger.primaryColor),
                    ),
                  ),
                ],
              ),
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text('Doctors near you', style: TextStyles.regular20.copyWith(fontFamily: 'Georgia')),
                  TextButton(
                    onPressed: () {
