...
class OnBoardingPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: TextStyles.defaultSpace),
      child: Column(
        children: [
          ...
          Stack(
            ...
            children: [Image.asset(image, width: 250)],
          ),
          ...
          const SizedBox(height: TextStyles.spaceBtwSections - 8),
